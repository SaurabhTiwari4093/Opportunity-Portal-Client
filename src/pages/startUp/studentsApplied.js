...
export default function StudentsApplied({
  BASE_URL,
  setShowAlert,
  setAlertMessage,
  setAlertSeverity,
  ...
  const convertToTableRows = (studentsApplied) => {
    ...
    for (let i = 0; i < studentsApplied.length; i++) {
      ...
      const convertedJsonData = {
        ...
        statusUpdate: {
          status: oneJsonData.status,
          studentId: oneJsonData.studentId,
        },
      };
        ...
        <Card>
          <CardContent>
            ...
            {loading ? (
              ...
              <StudentAppliedTable
                column={studentsAppliedTableColumn}
                row={studentsAppliedTableRow}
              />
            )}
          </CardContent>
        </Card>
