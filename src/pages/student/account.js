...
export default function Account({
  ...
  const updateOrSave =
    studentDetails.resumeLink === "" || studentDetails.resumeLink === undefined
      ? "Save"
      : "Update";
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={6}>
                ...
                >
                  ...
                  <MenuItem value={"Energy Science and Engineering"}>
                    Energy Science and Engineering
                  </MenuItem>
                  <MenuItem value={"Humanities and Social Sciences"}>
                    Humanities and Social Sciences
                  </MenuItem>
                  <MenuItem value={"Management Studies"}>
                    Management Studies
                  </MenuItem>
                  ...
                  <MenuItem value={"Textile and Fibre Engineering"}>
