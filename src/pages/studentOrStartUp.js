...
export default function StudentOrStartUp({
  BASE_URL,
  setShowAlert,
  setAlertMessage,
  setAlertSeverity,
      ...
      renderCell: ({ value }) => {
        return (
          <Button
            ...
            variant="outlined"
            disabled={
              value.deadline < moment().format("YYYY-MM-DDThh:mm")
                ? true
                : false
            }
            onClick={() => {
            ...
            <Grid item xs={6}>
              ...
              >
                <CardContent align="center">
                  ...
                  <Typography>
                    Are you a founder or a HR looking for Interns or Employee
                    for your startup.
                  </Typography>
                </CardContent>
              </Card>
            ...
            <Grid item xs={6}>
              ...
              >
                <CardContent align="center">
                  ...
                  <Typography>
                    Are you a Student who wants to work in an early stage
                    startup.
                  </Typography>
                </CardContent>
              </Card>
      ...
      <Card sx={{ mt: 2 }}>
        <CardContent>
          ...
          >
            ...
            <Button
              variant="contained"
              sx={{ width: 120, height: 40, mt: { xs: 2, md: 0 } }}
              onClick={() => {
