...
export default function App() {
  ...
  const getStudentAccountDetails = async () => {
    ...
    const url = `${BASE_URL}/api/student/register/${localStorage.getItem(
  ...
  const getStartUpAccountDetails = async () => {
    ...
    const url = `${BASE_URL}/api/startUp/register/${localStorage.getItem(
      "localStorageStartUpId"
    )}`;
    try {
      const response = await fetch(url, requestOptions);
      const data = await response.json();
            ...
            <Routes>
              ...
              >
                ...
                <Route
                  path="details"
                  element={
                    <JobDetails BASE_URL={BASE_URL} startUpDetails={null} />
                  }
                />
                <Route
                  path="signIn"
